(function($) {
    ...
    $(function() {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        },
                        {
                            ...
                            legendColor: gradientStrokeYellow,
                            pointRadius: 0,
                            fill: false,
                            borderWidth: 1,
                            fill: 'origin',
        ...
        if ($("#visit-sale-chart-dark").length) {
            ...
            gradientStrokeRed.addColorStop(0, 'rgba(249, 255, 161,1)');
            gradientStrokeRed.addColorStop(1, 'rgba(249, 255, 161,1)');
            var gradientLegendRed = 'linear-gradient(to right, rgba(249, 255, 161,1), rgba(249, 255, 161,1))';
