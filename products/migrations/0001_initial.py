    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farmer_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.farmer')),
                ('manager_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.manager')),
            ],
        ),
        migrations.CreateModel(
            name='stocks',
        ...
        migrations.AddField(
            ...
            name='manager_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.manager'),
        ),
    ]
